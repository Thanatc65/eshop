...
include("server.php");
$uid = $_SESSION['uid'];
$product = mysqli_query($conn, "SELECT * FROM products where uid ='$uid'");
...
if (isset($_POST["add"])) {
    ...
    $sql = "UPDATE products SET p_name='$p_name' , p_price='$p_price' , p_detail='$p_details' where id = '$id'";
...
<body style="background-color: #eee;">
                ...
                <div class="col-sm-3 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#"
                            id="<?php echo $row["id"];?>" class="btn btn-primary mt-4 text-center w-100 edit_data">Product Edit</a>
                            <a type="text" href="my_product.php?del=<?php echo $row["id"]; ?>" class="d-flex justify-content-center text-danger">Delete</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
    ...
    <!-- Modal -->
    <div class="modal fade" id="eModal" tabindex="-1" role="dialog" aria-hidden="true">
